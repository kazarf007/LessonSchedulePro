package com.jaygee.lessonschedual
...
import com.jaygee.lessonschedual.drawer.*
import com.jaygee.lessonschedual.model.*
import com.jaygee.lessonschedual.util.ClickJudger
import com.jaygee.lessonschedual.util.generateMultiLineString
import com.jaygee.lessonschedual.util.sumOfFloat

/**
 *  create on 13/2/2023
 **/
class LessonSchedualProView : View, View.OnTouchListener {
    ...
    constructor(context: Context, attr: AttributeSet) : super(context, attr) {
        context.obtainStyledAttributes(attr, R.styleable.LessonTableProView).apply {
            cellWidth = getDimension(R.styleable.LessonTableProView_cellWidth, 100f)
            weekNo = getInteger(R.styleable.LessonTableProView_weekNo, 5)
            lessonMaxNo = getInteger(R.styleable.LessonTableProView_lessonMaxNo, 8)
            dividerSize = getDimension(R.styleable.LessonTableProView_dividerSize, 0f)
            textPaddingSize = getDimension(R.styleable.LessonTableProView_textPaddingSize, 0f)
        }.recycle()
        setOnTouchListener(this)
    }

    fun configDrawer(borderDrawer : BorderDrawer? , lessonDrawer : LessonDrawer? , breakLessonDrawer : BreakDrawer?) : LessonSchedualProView {
    ...
    fun setLessonData(data: List<Lesson>): LessonSchedualProView {
        lessons.clear()
    ...
    fun setSerialBreakLessonData(data: List<BreakLesson>): LessonSchedualProView {
